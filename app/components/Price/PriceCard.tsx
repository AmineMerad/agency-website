...
const PriceCard = ({bg , num , price , plan } :Props) => {
    const large = num == "2"?'lg:scale-110 sclae-100 z-[100]': "";
  return (
    <div className={`relative ${large} bg-gray-100 shadow-md transform`}>
        <div className={`${bg} h-[200px] flex flex-col items-center justify-center rounded-t-md`}>
            ...
            <h1 className='text-[20px] text-white'>
                <span className='text-[20px] text-yellow-300 font-bold'>${price}/</span>
                Per Month
            </h1>
        </div>
        <div className='p-4 mt-[1rem] text-center'>
            ...
            mb-[1rem]'>Full Access Library
            </p>
            <p className='text-[16px] font-[500] border-b-[1.4px] border-gray-300 pb-2 text-black opacity-90
            mb-[1rem]'>Multiple Website
            </p>
            <p className='text-[16px] font-[500] border-b-[1.4px] border-gray-300 pb-2 text-black opacity-90
            mb-[1rem]'>Nex js Project
            </p>
            <p className='text-[16px] font-[500] border-b-[1.4px] border-gray-300 pb-2 text-black opacity-90
            mb-[1rem]'>MERN Stack Project
            </p>
            <p className='text-[16px] font-[500] border-b-[1.4px] border-gray-300 pb-2 text-black opacity-90
            mb-[1rem]'>TypeScript Project
            </p>
